    ...
    return (
        ...
        >
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                {data.map(({ company, time, location, title, img, content }, index) => (
                    <div
                        key={index}
                        className="flex justify-start pt-10 md:pt-40 md:gap-10"
                    >
                        <div
                            className="sticky flex flex-col z-40 items-start top-40 self-start max-w-xs lg:max-w-md md:w-full md:pl-20 gap-2">
                            <div
