                    ...
                    <div key={id}
                        ...
                        >
                            <div
                                ...
                                <div
                                    className="relative w-full h-full h-full overflow-hidden lg:rounded-3xl bg-[#13162d]">
                            ...
                            <p className="lg:text-xl lg:font-normal lg:font-light text-sm line-clamp-2">
                                {description}
                            </p>
                            ...
                            <div className="flex items-center justify-between mt-7 mb-3">
                                <div className="flex items-center">
                                    {iconLists.map((icon, index) => (
                                        <div key={icon}
                                             ...
                                             lg:h-10 w-8 h-8 fl ex justify-center items-center"
                                ...
                                <div className="flex justify-center items-center">
                                    <p className="flex lg:text-xl md:text-xs text-sm text-purple">Check In GitHub</p>
